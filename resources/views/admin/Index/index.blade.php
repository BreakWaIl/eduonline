...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="{{ url('admin/course/index') }}" data-title="数据流管理" href="javascript:void(0)">直播流管理</a></li>
					<li><a data-href="{{ url('admin/lesson/index') }}" data-title="直播课程管理" href="javascript:void(0)">直播课程管理</a></li>
			</ul>
		</dd>
	</dl>
